...
atomic {
  OVS_OVS_Infra_pts[4].OVS_Infra_pts[3] = true;
  OVS_OVS_Infra_pts[3].OVS_Infra_pts[4] = true;
  OVS_OVS_Infra_pts[3].OVS_Infra_pts[2] = true;  
  OVS_OVS_Infra_pts[2].OVS_Infra_pts[3] = true; 
  OVS_OVS_Infra_pts[2].OVS_Infra_pts[1] = true;
  OVS_OVS_Infra_pts[1].OVS_Infra_pts[2] = true;
  OVS_OVS_Infra_pts[1].OVS_Infra_pts[0] = true;
  OVS_OVS_Infra_pts[0].OVS_Infra_pts[1] = true;
