...
#define tot_OVS     8/* contains total number of OVS in the data plane topology*/
...
atomic {
  OVS_OVS_Infra_pts[7].OVS_Infra_pts[6] = true;
  OVS_OVS_Infra_pts[6].OVS_Infra_pts[7] = true;
  OVS_OVS_Infra_pts[7].OVS_Infra_pts[5] = true;  
  OVS_OVS_Infra_pts[5].OVS_Infra_pts[7] = true; 
  OVS_OVS_Infra_pts[6].OVS_Infra_pts[4] = true;
  OVS_OVS_Infra_pts[4].OVS_Infra_pts[6] = true;
