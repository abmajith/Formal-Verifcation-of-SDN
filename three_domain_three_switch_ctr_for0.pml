...
int no_OVS_dom[no_dom + 1] = {0, 1, 2, 3};
...
int c1 = 1;
 ...
 :: ( c1 < no_device )  -> int c2 = c1 + 1, cntt = 1, ju = 1, dd;
                ...
                Lq1:  /* I need to add the code for the other device first report to some IoT devices and check the rest of the formulae */
                    ...
                    if
                    :: ( ju == 1 ) -> if
                                      :: true ->   cont_que_ovs_rep[1]!maclearning,IoT,(no_OVS_dom[1]+1),c2,c2;
                                                   cont_que_ovs_rep[1]!maclearning,Infra,no_OVS_dom[2],1,c2;
                                                    dd = 2
                                      :: true ->  cont_que_ovs_rep[2]!maclearning,IoT,(no_OVS_dom[2]+1),c2,c2;
                                                  cont_que_ovs_rep[2]!maclearning,Infra,no_OVS_dom[3],1,c2;
                                                    dd = 3
                                      fi;
                                          goto Lq4
                    :: ( ju == 2 ) -> if
                                      :: true -> cont_que_ovs_rep[0]!maclearning,IoT,1,c2,c2;
